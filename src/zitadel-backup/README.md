...
# one-off + management:
docker compose --profile backup run --rm zitadel-backup --now
docker compose --profile backup run --rm zitadel-backup cli list
docker compose --profile backup run --rm zitadel-backup cli verify <id>
docker compose --profile backup run --rm zitadel-backup cli restore <id>   # stop Zitadel first
